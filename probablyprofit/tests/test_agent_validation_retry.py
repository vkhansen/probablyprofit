...
from probablyprofit.api.exceptions import SchemaValidationError, AgentException
...
async def test_openai_agent_retry_on_schema_error():
    ...
    valid_response.choices = [MagicMock(message=MagicMock(content='{"action": "hold", "confidence": 0.8}'))]
