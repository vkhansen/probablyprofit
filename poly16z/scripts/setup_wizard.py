...
# Add parent dir to path to find poly16z
...
def setup_wizard():
    ...
    if not pk:
        ...
        try:
            ...
            print("You may need to manually enter them or check if your PK has funds/gas (though not strictly needed for derivation).")
